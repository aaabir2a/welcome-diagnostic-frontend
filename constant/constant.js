export const BASE_URL = "http://192.168.68.112:8006";
...
export const GET_IMAGE_BY_MENU_ID = `${BASE_URL}/cms_menu_content_image/api/v1/get_all_cms_menu_content_image_by_cms_menu_id`;
