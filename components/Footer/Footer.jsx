        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4 mb-4">
              ...
              />
              <p>
                Welcome Diagnostic & Medical Center Services with its facilities
                and services is capable of screening migrant/guest workers and
                other international travelers from infectious and ...
              </p>
              {/* Social Icons */}
              <div>
    ...
    <i className={`fab fa-twitter fa-2x ${styles["hover-effect"]}`}></i>
            ...
            <div className="col-md-2 mb-4">
              ...
              <ul className={styles.custom}>
                ...
                <li>
                  <Link href="/medical-procedure">Medical Procedure</Link>
                </li>
                <li>
                  <Link href="/fitness-criteria">Fitness Criteria</Link>
                </li>
                <li>
